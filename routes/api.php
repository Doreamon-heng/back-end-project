...
Route::middleware(['auth:sanctum', 'user'])->group(function () {
    ...
    Route::get('/logout', [\App\Http\Controllers\api\AuthController::class, 'logout'])->name('logout')->middleware('auth:sanctum');

    // Add more user-specific routes as needed
    //route for user profile management
    Route::get('/profile', [\App\Http\Controllers\api\UserController::class, 'getProfile'])->name('profile.show')->middleware('auth:sanctum');
    Route::put('/profile', [\App\Http\Controllers\api\UserController::class, 'updateProfile'])->name('profile.update')->middleware('auth:sanctum');
    Route::delete('/profile', [\App\Http\Controllers\api\UserController::class, 'deleteProfile'])->name('profile.destroy')->middleware('auth:sanctum');
    ...
    Route::get('/categories_images', [\App\Http\Controllers\api\Category_imageController::class, 'index'])->name('categories_images.index');
    Route::get('/categories_images/{id}', [\App\Http\Controllers\api\Category_imageController::class, 'show'])->name('categories_images.show');
    ...
    Route::get('/products_images/{id}', [\App\Http\Controllers\api\Product_imageController::class, 'show'])->name('products_images.show');
    ...
    Route::get('/payments/{id}', [\App\Http\Controllers\api\PaymentController::class, 'show'])->name('payments.show');
    Route::post('/payments', [\App\Http\Controllers\api\PaymentController::class, 'store'])->name('payments.store');
    Route::put('/payments/{id}', [\App\Http\Controllers\api\PaymentController::class, 'update'])->name('payments.update');
    Route::delete('/payments/{id}', [\App\Http\Controllers\api\PaymentController::class, 'destroy'])->name('payments.destroy');

    //route for user images
